...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url="https://t.me/SVSTEAMSTUDIODISCUSSION")
                ],[
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/svs_team_bot")
                  ]]
        ...
        try:
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      InlineKeyboardButton('Dᴏᴡɴʟᴏᴀᴅ 📥', url="https://t.me/FileToLinkPro_Bot?start=True"),
                      InlineKeyboardButton('Sᴛʀᴇᴀᴍ 🖥', url="https://t.me/FileToLinkPro_Bot?start=True")
                   ],[
